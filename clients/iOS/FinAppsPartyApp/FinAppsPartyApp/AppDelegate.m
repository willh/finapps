...
- (NetworkingEngine *)networkingEngine {
    if (!_networkingEngine) {
        _networkingEngine = [[NetworkingEngine alloc] initWithDefaultEndpointAndApiKey:@"232c2d0a03"];
    }
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"FinAppsPartyApp" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"FinAppsPartyApp.sqlite"];
    ...
    if (![_persistentStoreCoordinator addPersistentStoreWithType:NSSQLiteStoreType configuration:nil URL:storeURL options:nil error:&error]) {
         ...
         */
        NSLog(@"Outdated Core Data storage was deleted");
    }    
